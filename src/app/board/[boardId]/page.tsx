  ...
  return (
    ...
    <div className="flex w-screen h-screen overflow-hidden bg-white">
      ...
      <section className="relative flex-[4] h-full border-r border-slate-200 overflow-hidden bg-slate-50">
        ...
        <Button className="absolute top-4 right-4 z-10  bg-blue-600 text-white rounded-lg shadow-lg hover:bg-blue-700 transition-colors duration-200 font-medium  flex items-center gap-2">
